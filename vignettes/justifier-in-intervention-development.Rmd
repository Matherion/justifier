...
### Get Scalable Vector Graphics
svg1 <- processedJustifications$decisionGraphsSvg$bcps_select_persuasivecomm;
svg2 <- processedJustifications$decisionGraphsSvg$subdeterminants_select_memory;

### Remove width and height to enable easy scaling
svg1 <- gsub('<svg width=\"[0-9]+pt\" height=\"[0-9]+pt\"\n viewBox=',
             '<svg viewBox=',
             svg1);
svg2 <- gsub('<svg width=\"[0-9]+pt\" height=\"[0-9]+pt\"\n viewBox=',
             '<svg viewBox=',
             svg2);
